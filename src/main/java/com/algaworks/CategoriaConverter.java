...
/**
 * Conversor personalizado para converter String para Categoria. Permite que o
 * Spring faça a conversão corretamente quando recebe valores como "🦷 Dentista"
 * ou "Dentista" do formulário.
 */
@Component
