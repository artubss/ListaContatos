...
/**
 * Classe que representa filtros para busca de contatos. Utiliza conceitos
 * avançados de Java como Builder Pattern e Optional.
 */
public class ContatoFiltro {
    ...
    public Optional<Boolean> getFavorito() {
        return favorito;
    }

    public Optional<LocalDate> getDataNascimentoInicio() {
        return dataNascimentoInicio;
    }

    public Optional<LocalDate> getDataNascimentoFim() {
